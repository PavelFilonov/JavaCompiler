...
class ClassNode(StmtNode):
    """Класс для представления в AST-дереве класса
    """

    def __init__(self, name: IdentNode, *stmts: StmtNode,
                 row: Optional[int] = None, col: Optional[int] = None, **props) -> None:
        super().__init__(row=row, col=col, **props)
        self.name = name
        self.stmts = stmts
    ...
    def __str__(self) -> str:
        return f'class: {str(self.name)}'.strip()
...
class ClassesNode(StmtNode):
    """Класс для представления в AST-дереве классов
    """

    def __init__(self, *classes: StmtNode,
                 row: Optional[int] = None, col: Optional[int] = None, **props) -> None:
        super().__init__(row=row, col=col, **props)
